...
public class Main {
    ...
    private static class VehicleUtil {
        ...
        public static Vehicle [] initVehicleArray () {
        ...
        public static void findMeliageExtrema (Vehicle [] vehicles) {
            ...
            printExtrema(max,min);

        }

        private static void printExtrema (Vehicle max, Vehicle min) {
    ...
    public static void main(String[] args) {
        ...
        Vehicle [] vehicles = VehicleUtil.initVehicleArray();
